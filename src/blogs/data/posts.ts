...
// export const QUERY_ALL_POSTS_SEARCH = ""
...
// export const QUERY_POSTS_BY_TAG_SLUG_INDEX = ""
// export const QUERY_POSTS_BY_TAG_SLUG_ARCHIVE = ""
// export const QUERY_POSTS_BY_CATEGORY_ID_ARCHIVE = ""
// export const QUERY_POSTS_BY_CATEGORY_ID = ""
// export const QUERY_POST_PER_PAGE = ""
// export const QUERY_POSTS_BY_AUTHOR_SLUG_INDEX = ""
// export const QUERY_POSTS_BY_AUTHOR_SLUG_ARCHIVE = ""
...
export const QUERY_ALL_POSTS_SEARCH = gql`
  query {
    posts(first: 10000) {
      edges {
        node {
...
export const QUERY_POSTS_BY_TAG_SLUG_INDEX = gql`
  ...
  query PostsByTagSlug($slug: String!) {
    posts(where: { tagSlugIn: $slug, hasPassword: false }) {
      edges {
        node {
          ...PostFields
        }
